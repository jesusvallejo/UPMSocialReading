 ...
 */
    ...
    public class UPMAuthenticationAuthorizationWSSkeletonSkeleton{
         ...
         */
                 ...
                 public es.upm.fi.sos.t3.backend.AddUserResponse addUser
                  (
                  es.upm.fi.sos.t3.backend.AddUser addUser
                  )
            {
                //TODO : fill this with the necessary business logic
         ...
         */
                 ...
                 public es.upm.fi.sos.t3.backend.ExistUserResponse existUser
                  (
                  es.upm.fi.sos.t3.backend.ExistUser existUser
                  )
            {
                //TODO : fill this with the necessary business logic
                throw new  java.lang.UnsupportedOperationException("Please implement " + this.getClass().getName() + "#existUser");
        }
